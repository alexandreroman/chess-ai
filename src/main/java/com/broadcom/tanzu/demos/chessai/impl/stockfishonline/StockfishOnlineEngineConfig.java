...
package com.broadcom.tanzu.demos.chessai.impl.stockfishonline;
...
@ConditionalOnProperty(name = "app.chess.engine", havingValue = "stockfishonline", matchIfMissing = true)
